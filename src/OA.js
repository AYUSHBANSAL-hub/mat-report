...
//   }
  function checkfrontend(){
    if(yo.data["Have you done any internships?"]=="Yes" && yo.data["Have you learnt any framework in Back-end like Node, Spring, Django etc?"]=="Yes" &&
    yo.data["Have you learnt any framework in Front-end like React, Angular etc?"]=="Yes"&& yo.data["Frontend Score"]=="30"){
